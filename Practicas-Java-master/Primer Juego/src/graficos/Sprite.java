...
public final class Sprite {
	...
	//colección de sprite del personaje
	...
	//fin colección de sprite del personaje
	...
	public static final Sprite BORDE_CARRETERA_DERECHA = new Sprite(32, 2,0,1, HojaSprites.desierto);
	public static final Sprite BORDE_CARRETERA_VERTICAL_ABAJO = new Sprite(32, 2,0,5, HojaSprites.desierto);
	public static final Sprite BORDE_CARRETERA_VERTICAL_ARRIBA = new Sprite(32, 2,0,4, HojaSprites.desierto);
	public static final Sprite CENTRO_CARRETERA = new Sprite(32,3,0,0, HojaSprites.desierto);
	public static final Sprite CENTRO_CARRETERA_HORIZONTAL = new Sprite(32,3,0,5, HojaSprites.desierto);
	public static final Sprite ESQUINA_CARRETERA = new Sprite(32,4,0,0, HojaSprites.desierto);
	public static final Sprite ESQUINA_CARRETERA_ARRIBA_IZQUIERDA = new Sprite(32,4,0,2, HojaSprites.desierto);
	public static final Sprite ESQUINA_CARRETERA_ARRIBA_DERECHA = new Sprite(32,4,0,3, HojaSprites.desierto);
	public static final Sprite ESQUINA_CARRETERA_ABAJO_DERECHA = new Sprite(32,4,0,1, HojaSprites.desierto);
	...
	public static final Sprite PARED_PIEDRA_CARRETERA = new Sprite(32,5,1,0, HojaSprites.desierto);
	public static final Sprite PARED_PIEDRA_CARRETERA_DERECHA = new Sprite(32,5,1,1, HojaSprites.desierto);
